...
Object.assign(window.GTMA_STRINGS, {
  ...
  "Respond to a focus area to decide how you'll act on it, and it shows up here, shared with your team and visible to HR. Not sure where to start? Create a custom pin from your own goal.": { nl: "Reageer op een aandachtsgebied om te bepalen wat je ermee doet. Het verschijnt dan hier, gedeeld met je team en zichtbaar voor HR. Weet je niet waar je moet beginnen? Maak een eigen pin vanuit je eigen doel.", de: "Reagieren Sie auf einen Schwerpunkt, um festzulegen, wie Sie damit umgehen. Er erscheint dann hier, geteilt mit Ihrem Team und sichtbar für HR. Sie wissen nicht, wo Sie anfangen sollen? Erstellen Sie eine eigene Markierung aus Ihrem eigenen Ziel." },
